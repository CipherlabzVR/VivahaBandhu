    ...
    return (
        <section className="top-profiles-section">
            ...
            <div className="top-profiles-list">
                <div className="search-profile-card">
                    ...
                    <div className="profile-info-section">
                        <div className="profile-info-item">
                            ...
                            <span className="profile-info-text">Nethmi</span>
                        </div>
                        <div className="profile-info-item">
                            <svg className="profile-info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                            </svg>
                            <span className="profile-info-text">26 yrs</span>
                        </div>
                        <div className="profile-info-item">
                            <svg className="profile-info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="profile-info-item">
                            ...
                            <span className="profile-info-text">Colombo</span>
                        </div>
                        <div className="profile-info-item">
                            <svg className="profile-info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button className="view-profile-btn" onClick={onOpenProfileDetail}>{t('viewProfile')}</button>
                </div>
                ...
                <div className="search-profile-card">
                    ...
                    <div className="profile-info-section">
                        <div className="profile-info-item">
                            ...
                            <span className="profile-info-text">Kasun</span>
                        </div>
                        <div className="profile-info-item">
                            <svg className="profile-info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                            </svg>
                            <span className="profile-info-text">29 yrs</span>
                        </div>
                        <div className="profile-info-item">
                            <svg className="profile-info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                            </svg>
                            <span className="profile-info-text">5' 8"</span>
                        </div>
                        <div className="profile-info-item">
                            <svg className="profile-info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
                            <span className="profile-info-text">Business Analyst</span>
                        </div>
                        <div className="profile-info-item">
                            <svg className="profile-info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                            ...
                            <span className="profile-info-text">Kandy</span>
                        </div>
                        <div className="profile-info-item">
                            <svg className="profile-info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9" />
                ...
                <div className="search-profile-card">
                    <div className="profile-photo-container">
                        <img src="https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=400" alt="Profile" className="profile-photo" />
                    </div>
                    <div className="profile-info-section">
                        <div className="profile-info-item">
                            <svg className="profile-info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span className="profile-info-text">Dilani</span>
                        </div>
                        <div className="profile-info-item">
                            <svg className="profile-info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                            </svg>
                            <span className="profile-info-text">24 yrs</span>
                        </div>
                        <div className="profile-info-item">
                            <svg className="profile-info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                            </svg>
                            <span className="profile-info-text">5' 2"</span>
                        </div>
                        <div className="profile-info-item">
                            <svg className="profile-info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
                            <span className="profile-info-text">Medical Doctor</span>
                        </div>
                        <div className="profile-info-item">
                            <svg className="profile-info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                            ...
                            <span className="profile-info-text">Gampaha</span>
                        </div>
                        <div className="profile-info-item">
                            <svg className="profile-info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9" />
                ...
                <div className="search-profile-card">
                    ...
                    <div className="profile-info-section">
                        <div className="profile-info-item">
                            ...
                            <span className="profile-info-text">Tharindu</span>
                        </div>
                        <div className="profile-info-item">
                            <svg className="profile-info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                        ...
                        <div className="profile-info-item">
                            ...
                            <span className="profile-info-text">5' 10"</span>
                        </div>
                        <div className="profile-info-item">
                            <svg className="profile-info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
                            <span className="profile-info-text">Project Manager</span>
                        </div>
                        <div className="profile-info-item">
                            <svg className="profile-info-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
