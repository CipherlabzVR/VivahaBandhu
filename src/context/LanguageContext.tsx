...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'heroTrustBadge': 'Trusted by thousands of families',
    'heroNameSearchPlaceholder': 'Search by account name or profession...',
    'heroInlineSearch': 'Search',
    'heroUpgradeToPremium': 'Upgrade to Premium',
    'heroBrowsePartners': 'Browse Partners',
    'heroVerifiedBadgeTitle': '100% Verified Profiles',
    'heroVerifiedBadgeSubtitle': 'Safe. Secure. Reliable.',
    'heroStatVerifiedSub': 'Genuine & active',
    'heroStatSuccessSub': 'Happy couples',
    'heroStatMatchmakerSub': 'Personalized support',
    'heroStatPrivacyTitle': '100%',
    'heroStatPrivacyLabel': 'Privacy protected',
    'heroStatPrivacySub': 'Your safety is our priority',
    'heroTagline': 'Building relationships. Creating futures.',
    // Features Section
    ...
    'topLiveProfilesDesc': 'Premium subscribed members who are active and looking for matches.',
    ...
    'matchmakerDesc': 'Join as a professional matchmaker. Pay for each client account you create — no fixed packages, add as many accounts as you need.',
    ...
    'convertToMatchmakerTitle': 'Convert to Matchmaker account?',
    'convertToMatchmakerConfirm': 'Your account will be changed to a Matchmaker account on the free Matchmaker plan (any Self premium is removed). Your detailed matrimonial profile, interests, shortlists, and messages on this main account will be removed. Managed client profiles stay under your account. Do you want to continue?',
    'convertToMatchmakerConfirmBtn': 'Yes, convert to Matchmaker',
    'convertToMatchmakerCancelBtn': 'Cancel',
    'convertToMatchmakerWorking': 'Converting…',
    'convertToMatchmakerSuccess': 'Your account is now a Matchmaker account.',
    'convertToMatchmakerFailed': 'Could not convert your account. Please try again.',
    'convertToMatchmakerPendingBank': 'You have a bank transfer awaiting approval. Wait until it is approved or rejected before converting to Matchmaker.',
    'dailyProfileViewsLimitTitle': 'Free plan profile views',
    'dailyProfileViewsLimitDesc': 'You have {remaining} of {limit} free profile views left today ({used} used).',
    'dailyProfileViewsExhaustedTitle': "You've reached today's free profile views",
    'dailyProfileViewsExhaustedDesc': 'Free members can open up to {limit} profiles per day. Upgrade for unlimited views.',
    'dailyProfileViewsLeftLabel': 'left today',
    'dailyProfileViewsUpgrade': 'Upgrade',
    ...
    'contactCareDetail': 'Experiencing issues with registration or login on MyMatch.lk? Reach out to our customer care at 0707718055. You can also message us via WhatsApp or Viber anytime.',
    'contactAddress': '150/1 Ja-Ela Road, Gampaha',
    'contactPhone': '0707718055',
    'contactEmail': 'support@mymatch.lk',
    'contactInfoEmail': 'info@mymatch.lk',
    'firstName': 'First Name',
    'lastName': 'Last Name',
    'emailRequired': 'Email *',
    'messageLabel': 'Message',
    'sendButton': 'Send',
    'contactFormSuccess': 'Thank you. Your message has been sent — our team will get back to you soon.',
    'contactFormError': 'Could not send your message. Please try again or email us directly.',
    'contactFormValidation': 'Please enter your email and message.',
    'contactFormSending': 'Sending…',
    'subscriptionTimeExpired': 'Subscription expired',
    'subscriptionOneDayRemaining': '1 day remaining',
    'subscriptionDaysRemaining': '{n} days remaining',
    'subscriptionHoursRemaining': '{n} hours remaining',
    'subscriptionExpiresToday': 'Expires today',
    'subscriptionEndsOn': 'Ends {date}',
    'subscriptionLifetime': 'Lifetime membership',
    'subscriptionBillingPeriodSelf': '6-month billing period',
    'subscriptionBillingPeriodMatchmaker': '6-month billing period',
  },
  si: {
    'home': 'මුල් පිටුව',
    'settings': 'සැකසුම්',
    ...
    'heroTrustBadge': 'දහස් ගණනක පවුල් විසින් විශ්වාස කෙරේ',
    'heroNameSearchPlaceholder': 'ගිණුම් නම හෝ වෘත්තිය අනුව සොයන්න...',
    'heroInlineSearch': 'සොයන්න',
    'heroUpgradeToPremium': 'ප්‍රිමියම් වෙත උත්ශ්‍රේණි කරන්න',
    'heroBrowsePartners': 'හවුල්කරුවන් පිරික්සන්න',
    'heroVerifiedBadgeTitle': '100% සත්‍යාපනය කළ පැතිකඩ',
    'heroVerifiedBadgeSubtitle': 'ආරක්ෂිතයි. විශ්වාසදායකයි.',
    'heroStatVerifiedSub': 'සැබෑ සහ සක්‍රිය',
    'heroStatSuccessSub': 'සතුටු යුවලයින්',
    'heroStatMatchmakerSub': 'පුද්ගලීකරණය කළ සහාය',
    'heroStatPrivacyTitle': '100%',
    'heroStatPrivacyLabel': 'රහස්‍යතාව ආරක්ෂිතයි',
    'heroStatPrivacySub': 'ඔබේ ආරක්ෂාව අපගේ ප්‍රමුඛතාවයයි',
    'heroTagline': 'සම්බන්ධතා ගොඩනගමින්. අනාගතය නිර්මාණය කරමින්.',
    // Features Section
    ...
    'topLiveProfilesDesc': 'ක්‍රියාකාරී වන ප්‍රිමියම් දායක සාමාජිකයින් — දැන් ගැලපීම් සොයමින්.',
    ...
    'convertToMatchmakerTitle': 'ගැලපීම් කරන්නාගේ ගිණුමකට පරිවර්තනය කරන්නද?',
    'convertToMatchmakerConfirm': 'ඔබේ ගිණුම නොමිලේ ගැලපීම් කරන්නාගේ සැලසුමට වෙනස් වේ (Self ප්‍රිමියම් ඉවත් වේ). මෙම ප්‍රධාන ගිණුමේ විස්තරාත්මක විවාහ පැතිකඩ, උනන්දුවන්, කෙටි ලැයිස්තු සහ පණිවිඩ ඉවත් වේ. කළමනාකරණය කරන සේවාදායක පැතිකඩ ඔබේ ගිණුම යටතේ රැඳේ. ඉදිරියට යන්නද?',
    'convertToMatchmakerConfirmBtn': 'ඔව්, ගැලපීම් කරන්නාට පරිවර්තනය කරන්න',
    'convertToMatchmakerCancelBtn': 'අවලංගු කරන්න',
    'convertToMatchmakerWorking': 'පරිවර්තනය වෙමින්…',
    'convertToMatchmakerSuccess': 'ඔබේ ගිණුම දැන් ගැලපීම් කරන්නාගේ ගිණුමකි.',
    'convertToMatchmakerFailed': 'ගිණුම පරිවර්තනය කළ නොහැකි විය. නැවත උත්සාහ කරන්න.',
    'convertToMatchmakerPendingBank': 'ඔබට අනුමත කිරීමට බලා සිටින බැංකු මාරුවක් ඇත. එය අනුමත හෝ ප්‍රතික්ෂේප වන තෙක් ගැලපීම් කරන්නාට පරිවර්තනය කළ නොහැක.',
    'dailyProfileViewsLimitTitle': 'නොමිලේ සැලැස්මේ පැතිකඩ බැලීම්',
    'dailyProfileViewsLimitDesc': 'අද ඔබට නොමිලේ පැතිකඩ බැලීම් {remaining}/{limit}ක් ඉතිරිව ඇත ({used}ක් භාවිතා කර ඇත).',
    'dailyProfileViewsExhaustedTitle': 'අද සඳහා නොමිලේ පැතිකඩ බැලීම් අවසන් වී ඇත',
    'dailyProfileViewsExhaustedDesc': 'නොමිලේ සාමාජිකයින්ට දිනකට පැතිකඩ {limit}ක් දක්වා විවෘත කළ හැක. අසීමිත බැලීම් සඳහා උත්ශ්‍රේණි කරන්න.',
    'dailyProfileViewsLeftLabel': 'අද ඉතිරි',
    'dailyProfileViewsUpgrade': 'උත්ශ්‍රේණි කරන්න',
    ...
    'contactCareDetail': 'MyMatch.lk හි ලියාපදිංචි වීම හෝ ඇතුළු වීමේ ගැටළු තිබේද? අපගේ රැකියා සේවාවට 0707718055 දක්වා අමතන්න. ඔබට WhatsApp හෝ Viber හරහා ඕනෑම වේලාවක අපට පණිවිඩ යැවිය හැකිය.',
    'contactAddress': '150/1 ජා-ඇල පාර, ගම්පහ',
    'contactPhone': '0707718055',
    'contactEmail': 'support@mymatch.lk',
    'contactInfoEmail': 'info@mymatch.lk',
    'firstName': 'මුල් නම',
    ...
    'sendButton': 'යවන්න',
    'contactFormSuccess': 'ස්තූතියි. ඔබේ පණිවිඩය යවා ඇත — අපේ කණ්ඩායම ඉක්මනින් ඔබ හා සම්බන්ධ වේ.',
    'contactFormError': 'පණිවිඩය යැවීමට නොහැකි විය. නැවත උත්සාහ කරන්න හෝ ඊමේල් කරන්න.',
    'contactFormValidation': 'කරුණාකර ඔබේ ඊමේල් සහ පණිවිඩය ඇතුළත් කරන්න.',
    'contactFormSending': 'යවමින්…',
    'subscriptionTimeExpired': 'දායකත්වය කල් ඉකුත් වී ඇත',
    'subscriptionOneDayRemaining': 'දින 1ක් ඉතිරිව ඇත',
    'subscriptionDaysRemaining': 'දින {n}ක් ඉතිරිව ඇත',
    'subscriptionHoursRemaining': 'පැය {n}ක් ඉතිරිව ඇත',
    'subscriptionExpiresToday': 'අද කල් ඉකුත් වේ',
    'subscriptionEndsOn': '{date} දක්වා',
    'subscriptionLifetime': 'ජීව කාල සාමාජිකත්වය',
    'subscriptionBillingPeriodSelf': 'මාස 6 බිල්පත් කාලය',
    'subscriptionBillingPeriodMatchmaker': 'මාස 6 බිල්පත් කාලය',
  },
};
