...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'convertToMatchmakerConfirm': 'Your account will be changed to a Matchmaker account. Any detailed matrimonial profile information you already filled will be removed. Managed client profiles stay under your account. Do you want to continue?',
    ...
    'contactFormInvalidEmail': 'Enter a valid email with a proper domain (example: name@gmail.com).',
  ...
  si: {
    ...
    'convertToMatchmakerConfirm': 'ඔබේ ගිණුම ගැලපීම් කරන්නාගේ ගිණුමකට වෙනස් වේ. ඔබ දැනටමත් පුරවා ඇති විස්තරාත්මක විවාහ පැතිකඩ තොරතුරු ඉවත් වේ. කළමනාකරණය කරන සේවාදායක පැතිකඩ ඔබේ ගිණුම යටතේ රැඳේ. ඉදිරියට යන්නද?',
    ...
    'contactFormInvalidEmail': 'නිවැරදි වසමක් සහිත වලංගු ඊමේල් ලිපිනයක් ඇතුළත් කරන්න (උදා: name@gmail.com).',
